<template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
    <div class="container-fluid">
      <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
        <h2 class="text-muted fw-bold" href="#">TEKNOKOZ</h2>
        <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <button type="button" class="btn btn-outline-secondary border border-secondary rounded-pill">Destek</button>
        </ul>
      </div>
    </div>
  </nav>
  <div class="container mt-10 mb-5">
    <div class="row text-start">
      <div class="col-md-4">
        <img src="../assets/img/1.jpg" width="430" alt="teknokoz">
      </div>
    ...
    <h6 class="mt-15">Aşağı Kaydır ↓</h6>
    <div class="row text-start mt-10">
      <div class="col-md-8 pe-5 pt-100">
      ...
      <div class="col-md-4">
        <img src="../assets/img/2.png" width="430" alt="teknokoz">
      </div>
      <div class="d-flex mt-10 text-webkit-center">
        <div class="">
          <i class="fa-solid fa-file fa-3x mb-4 text-body"></i>
          <p class="w-75">Lorem ipsum dolor sit amet consectetur adipisicing </p>
        </div>
        <div>
          <i class="fa-solid fa-code fa-3x mb-4 text-body"></i>
          <p class="w-75">Lorem ipsum dolor sit amet consectetur adipisicing </p>
        </div>
        <div>
          <i class="fa-solid fa-gear fa-3x mb-4 text-body"></i>
          <p class="w-75">Lorem ipsum dolor sit amet consectetur adipisicing </p>
        </div>
        <div>
          <i class="fa-solid fa-pen-to-square fa-3x mb-4 text-body"></i>
          <p class="w-75">Lorem ipsum dolor sit amet consectetur adipisicing </p>
        </div>
      </div>
    </div>
    ...
    <div class="row text-start mt-10">
      ...
      <div class="col-md-4">
        <img src="../assets/img/4.png" width="430" alt="teknokoz">
      </div>
    </div>
  </div>
  <div class="bg-pgradient mt-10">
    <div class="col-md-4 mx-auto">
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <h1 class="fw-bold text-white pt-5">Sizden Gelenler</h1>
          <div class="carousel-item active">
            <div class="row">
              <p class="text-white mt-5"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras justo neque, suscipit nec ligula vitae, feugiat venenatis tellus. In molestie ut massa quis dictum. Vivamus tincidunt dignissim magna, non eleifend mauris viverra in. Nam suscipit neque ex, vitae accumsan urna consequat ut. Vivamus maximus fringilla est ut aliquet. Phasellus aliquam nec odio vel placerat. </p>
              <span class="text-white mt-5"> Alev Yıldırım </span>
              <span class="text-danger"> Co-Founder, Otosan </span>
          ...
          <div class="carousel-item">
            <div class="row">
              <p class="text-white mt-5"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras justo neque, suscipit nec ligula vitae, feugiat venenatis tellus. In molestie ut massa quis dictum. Vivamus tincidunt dignissim magna, non eleifend mauris viverra in. Nam suscipit neque ex, vitae accumsan urna consequat ut. Vivamus maximus fringilla est ut aliquet. Phasellus aliquam nec odio vel placerat. </p>
              <span class="text-white mt-5"> Murat Kale </span>
          ...
          <div class="carousel-item">
            <div class="row">
              <p class="text-white mt-5"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras justo neque, suscipit nec ligula vitae, feugiat venenatis tellus. In molestie ut massa quis dictum. Vivamus tincidunt dignissim magna, non eleifend mauris viverra in. Nam suscipit neque ex, vitae accumsan urna consequat ut. Vivamus maximus fringilla est ut aliquet. Phasellus aliquam nec odio vel placerat. </p>
              <span class="text-white mt-5"> Can Meydan </span>
